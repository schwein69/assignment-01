...
public class BoidWorker extends Thread {
    ...
    public BoidWorker(BoidsModel model, int startIdx, int endIdx, Lock lock, Condition notCompleted, Condition restartCondition, boolean restart, AtomicInteger counter) {
        this.model = model;
    ...
    public void run() {
        while (!Thread.currentThread().isInterrupted()) {
            ...
            try {
                ...
                update(model);
                System.out.println(Thread.currentThread().getName() + " Ho finito:da " + this.startIdx + " a " + this.endIdx);
                ...
                restartCondition.await();
                System.out.println("restarto");
            } catch (
                    InterruptedException e) {
                Thread.currentThread().interrupt(); // Ensure interruption is respected
